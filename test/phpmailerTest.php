...
EOT;
    ...
    public function testAddressing()
    {
        ...
        $this->assertTrue($this->Mail->addAddress('a (b) [c@example.com]'), 'Fancy Addressing failed');
        $this->assertTrue($this->Mail->addAddress('"a b" <c@example.com>'), 'Fancy Addressing failed');
        ...
        $this->Mail->Sender = '';
        $this->Mail->setFrom('"A B" (C) <d@example.com>', '', false);
        $this->assertEquals($this->Mail->Sender, '', 'setFrom should not have set sender');
        $this->assertEquals($this->Mail->From, 'd@example.com', 'setFrom failed to set address from fancy address');
        $this->assertEquals($this->Mail->FromName, 'A B (C)', 'setFrom failed to set name from fancy address');
        $this->Mail->clearCCs();
        $this->Mail->clearBCCs();
