...
$PHPMAILER_LANG['buggy_php']            = 'Votre version de PHP est affectée par un bogue qui peut entraîner des messages corrompus.' .
                                          ' Pour résoudre ce problème, passez à l’envoi par SMTP, désactivez l’option mail.add_x_header dans le fichier' .
                                          ' php.ini, passez à MacOS ou Linux, ou passez PHP à la version 7.0.17+ ou 7.1.3+.';
...
$PHPMAILER_LANG['smtp_connect_failed']  = 'La fonction SMPT connect() a échouée.';
