...
*   [MailHog](https://github.com/les-enovateurs/mailhog-examples), a Go-based email testing tool for developer with a web interface. You can use it with Docker and GitHub Actions to test mail.
